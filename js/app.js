...
const switchTab = (id) => {
  if (id === "posts") {
    ...
    document.getElementById("liked-post").style.display = "none";
    document.getElementById("reported-area").style.display = "none";
    document.getElementById("posts").style.display = "grid";
    document.getElementById("liked").style.display = "none";
    document.getElementById("reported").style.display = "none";
  } else if (id === "liked") {
    document.getElementById("bonus").style.display = "none";
    document.getElementById("liked-post").style.display = "block";
    document.getElementById("reported-area").style.display = "none";
    ...
    document.getElementById("bonus").style.display = "none";
    document.getElementById("reported-area").style.display = "block";
    document.getElementById("liked-post").style.display = "none";
